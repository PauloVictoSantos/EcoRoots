      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          >
            {highlights.map((item, index) => (
              ...
              >
                <item.icon className="w-5 h-5 text-[#58D68D]" />
                <div>
          ...
          >
            <Button
              asChild
              variant="outline"
              className="border-[#58D68D]/30 hover:bg-[#58D68D]/10 text-foreground rounded-xl"
            >
              <Link href="/sobre">
                Saiba Mais
        ...
        >
          <GlassCard className="p-8 relative overflow-hidden" hover={false}>
            {/* Decorative elements */}
            <div className="absolute top-0 right-0 w-40 h-40 bg-[#58D68D]/10 rounded-full blur-3xl" />
            <div className="absolute bottom-0 left-0 w-32 h-32 bg-[#1E8449]/20 rounded-full blur-3xl" />
            ...
            <div className="relative grid grid-cols-2 gap-4">
              ...
              >
                <span className="text-3xl font-bold text-[#58D68D]">5+</span>
